    ...
    return (
        <>
            <form onSubmit={formHandler}>
                ...
                <label htmlFor="start-prom-input">Inicio:</label>
                <input id="start-prom-input" type="datetime-local"
                       value={startTime}
                       onChange={(e) => console.log(e.target.value)}
                />

                <label htmlFor="end-prom-input">Fin:</label>
                <input id="end-prom-input" type="datetime-local"
                       value={endTime}
                       onChange={(e) => setEndTime(e.target.value)}
                />

                <label htmlFor="discount-input">Descuento:</label>
                <input id="discount-input" type="number" value={discount}
                       onChange={(e) => setDiscount(e.target.value)}
                />

                <button type="submit">{newPromo ? 'Crear' : 'Editar'} Promoción</button>
            </form>
        </>
    )
}
