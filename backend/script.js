...
const sqlQuery18 = `
    ...
    (1, 'johndoe@example.com', 'password123', 'user'),
    (2, 'janesmith@example.com', 'password123', 'user'),
    (3, 'alicejohnson@example.com', 'password123', 'user'),
    (4, 'bobbrown@example.com', 'password123', 'user'),
    (5, 'charliedavis@example.com', 'password123', 'user'),
    (6, 'dulcemariafabian@hotmail.com', 'password123', 'admin'),
    (7, 'meumeroy@gmail.com', 'password123', 'admin'),
    (8, 'gracegreen@example.com', 'password123', 'user'),
    (9, 'hannahblue@example.com', 'password123', 'user'),
    (10, 'ianorange@example.com', 'password123', 'user');`
